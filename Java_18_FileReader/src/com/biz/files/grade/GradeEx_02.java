...
public class GradeEx_02 {
	...
	public static void main(String[] args) {
		...
		}catch(NumberFormatException ne) {			//FileGradeService.read() method가 실행되는 중에 만약 문자열형 숫자를
													//숫자로 바꾸는 과정에서 exception이 발생하면 throw new NumberFormatException으로 toss하고
																	//main()에서는 해당 exception에 대해서 다른 exception과 처리를 분리
			System.out.println("데이터 파일을 확인");
		}catch (IOException e) {
